...
$data['type']=(int) $data['type'];
	...
	if(empty($errors)) {
        ...
        echo '<div style="color: green; "> Регистрация успешна! Можно <a href="/bd_student_online/index.php">Вернуться на главну</a>.</div><hr>';
...
<div class="container mt-4">
	   ...
	   <!-- Форма регистрации -->
		...
		<br>
		<p>Вернуться на <a href="/bd_student_online/index.php">главную</a>.</p>
			</div>
		</div>
	</div>
